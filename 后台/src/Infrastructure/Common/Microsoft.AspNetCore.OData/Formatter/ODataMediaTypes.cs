...
namespace Microsoft.AspNetCore.OData.Formatter
{
    ...
    {
        private static readonly MediaTypeHeaderValue _applicationJson = MediaTypeHeaderValue.Parse("application/json;charset=utf-8");
        ...
        public static ODataMetadataLevel GetMetadataLevel(MediaTypeHeaderValue contentType)
        {
            ...
            if (!String.Equals(ODataMediaTypes.ApplicationJson.MediaType.Value, contentType.MediaType.Value,
