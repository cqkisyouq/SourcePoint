...
namespace Microsoft.AspNetCore.OData.Extensions
{
    ...
    public static class SerializableErrorExtensions
    {
        ...
        public static ODataError CreateODataError(this SerializableError serializableError)
        {
            ...
            {
                Message = JsonConvert.SerializeObject(serializableError.Values),//serializableError.GetPropertyValue<string>(SerializableErrorKeys.MessageKey),
                ...
                Details= ConvertModelStateErrorItems(serializableError)
            };
        }
        ...
        private static List<ODataErrorDetail> ConvertModelStateErrorItems(SerializableError error)
        {
            List<ODataErrorDetail> errorItems = new List<ODataErrorDetail>();
            foreach (var item in error)
            {
                errorItems.Add(new ODataErrorDetail() {
                    Message=JsonConvert.SerializeObject(item.Value),
                    Target=item.Key
                });
            }
            return errorItems;
        ...
        private static string ConvertModelStateErrorToJson(SerializableError error)
        {
            ...
            return JsonConvert.SerializeObject(errorItems);
        }
